...
class LoginRepositoryImpl(private val userLoginStorage: UserLoginStorage): LoginRepository {

    override fun loginUser(email: String, password: String, onSuccess: () -> Unit, onFailure: (String) -> Unit) {
